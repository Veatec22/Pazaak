...
describe('card model', () => {
  it('is the authentic 18 plus/minus/flip cards', () => {
    expect(FULL_COLLECTION).toHaveLength(18);
...
describe('engine setup', () => {
  ...
  it('never deals a hand with two cards of the same code', () => {
    for (let seed = 0; seed < 200; seed++) {
      const g = game(seed, null);
