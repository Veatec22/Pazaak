...
export const translations = {
  en: {
    ...
    single_player_desc: 'Duel the computer (offline)',
    single_player_title: 'Single Player',
    quick_play: 'Quick Match',
    quick_play_desc: 'One-off duel — pick your card pool',
    campaign: 'Campaign',
    campaign_desc: 'Climb the opponent ladder, KotOR-style',
  ...
  pl: {
    ...
    single_player_desc: 'Pojedynek z komputerem (offline)',
    single_player_title: 'Jednoosobowa',
    quick_play: 'Szybki mecz',
    quick_play_desc: 'Pojedynczy pojedynek — wybierz pulę kart',
    campaign: 'Kampania',
    campaign_desc: 'Wespnij się po drabince przeciwników, jak w KotOR',
