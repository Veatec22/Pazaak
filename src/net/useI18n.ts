...
const translations = {
  ...
  pl: {
    ...
    online_lobby_connected: 'Przeciwnik polaczony.',
    online_lobby_guest: 'Gosc',
    online_lobby_mode: 'Tryb meczu',
    online_lobby_guest_ready: 'Gosc jest gotowy',
    online_lobby_guest_not_ready: 'Gosc nie jest gotowy',
    online_lobby_you_ready: 'Jestes gotowy',
    online_lobby_you_not_ready: 'Wybierz tryb i potwierdz gotowosc',
    online_lobby_kicked_title: 'Usunieto z meczu',
    online_lobby_kicked: 'Host usunal Cie z tego meczu.',
    btn_ready: 'Gotowy',
