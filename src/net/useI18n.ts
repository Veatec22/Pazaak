...
const translations = {
  en: {
    ...
    deck_builder_desc: 'Choose exactly 10 side cards. Duplicates are allowed.',
    available_cards: 'Available Cards',
    chosen_cards: 'Chosen Cards',
    add_card: 'Add {card}',
    remove_card: 'Remove {card}',
    btn_save_deck: 'Save Deck',
    btn_clear_deck: 'Clear Deck',
  ...
  pl: {
    ...
    deck_builder: 'Budowa talii',
    deck_builder_desc: 'Wybierz dokładnie 10 kart bocznych. Duplikaty są dozwolone.',
    available_cards: 'Dostępne karty',
    chosen_cards: 'Wybrane karty',
    add_card: 'Dodaj {card}',
    remove_card: 'Usuń {card}',
    btn_save_deck: 'Zapisz talię',
    btn_clear_deck: 'Wyczyść talię',
