/**
 * Dedicated KotOR II pazaak sound cues (extracted from Sounds.bif → mgs_* minigame
 * sounds). Played through the Web Audio API, same approach as the app-wide uiSounds.
 * No-ops where Web Audio is unavailable (e.g. jsdom in tests).
 */
