/** Maps engine card codes/values to the extracted KotOR II pazaak art in /public/pazaak. */
...
/**
 * Face art for a card on the table, chosen from its label the way KotOR does:
 * green for main-deck values, blue for +, red for -, gold for the "double" card.
 */
